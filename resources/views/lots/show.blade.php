        ...
        <div id="content" style="text-align:center">
            <div class="textleft">
                ...
                <div>
                    ...
                    <label for="lot_condition" class="label">Condition</label><input type="text" size="50" class="input"
                        disabled name="lot_condition" id="lot_condition" value="{{$lot->lot_condition ?? ''}}" /><br>
                    <label for="lot_location" class="label">Location</label><input type="text" size="50" class="input"
                        disabled name="lot_location" id="lot_location" value="{{$lot->lot_location ?? ''}}" /><br>
                    <label for="pretax_amount" class="label">Pretax $</label><input type="number" step="0.01" disabled
                        size="50" class="input" name="pretax_amount" id="pretax_amount" disabled
                    ...
                    <label for="date_won" class="label">Date Won</label><input type="date" disabled step="1" size="50"
                        class="input" name="date_won" id="date_won"
