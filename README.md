# NRI Web Development Challenge(Kindly download and unzip webdev-challenge-master.zip AND in the project folder "webdev-challenge-master" there is readme.md file - a guide to run the challenge project) THANK YOU
