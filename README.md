...
2.Run xampp or any other server
3.Run following commands on terminal in root directory.
 composer install
 php artisan migrate (don't forget to create databse in phpmyadmin first - named nri)
 php artisan serve
